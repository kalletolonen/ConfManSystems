...
So the article needs updating, as it's not possible to install and use vargant + virtualbox with the instructions it provides (on a Debian 11/Virtualbox 6.0-system). 
...
I tried to better my understanding from [the documentation](https://docs.saltproject.io/salt/user-guide/en/latest/topics/states.html), but I wasn't able to figure out the things I didn't understand on the printout.  
...
##d) d) Idempotenssi. Tee idempotentti esimerkkikomento saltilla. Aja komentoa useita kertoja. Osoita selitetyin esimerkein, että komentosi on idempotentti.  
