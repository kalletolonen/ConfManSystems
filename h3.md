...
I tested my state some more and realized, that the command for sudoeditor's change doesn't do anything. You can find an up-to-date version of my salt state [here](https://github.com/kalletolonen/desktop).