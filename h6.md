...
The installer had created a salt-folder in c:\. I navigated there and there I could execute *.bat-files, that are Windows script files (from my knowledge of Windows in the 90's). 
